...
import com.dhernandez.firmadigital.List_Firmas;

import java.util.ArrayList;
import java.util.List;

public class ConexionSQLite {
    List<Asignaturess> list = new ArrayList<>();
    SQLiteDatabase db;
    Asignaturess asignaturess=new Asignaturess();
    ...
    public List<Asignaturess> getData(){
        ...
        while(cursor.moveToNext()){
            ...
            Asignaturess asignaturess = new Asignaturess(cursor.getInt(id),descripcion, imagen);
            list.add(asignaturess);
        }
        return list;
    }
